...
A primeira heurística, denominada threshold, é apresentada na figura~\ref{threshold}. O LTMS após definir para qual fila pretende migrar o thread atual, consulta com o thread qual a razão entre a quantidade de aborts e commits. Se o resultado da razão entre os aborts e commits do thread atual forem superior a um limiar, previamente estipulado pelo desenvolvedor, o escalonador decide por migrar o thread atual.
