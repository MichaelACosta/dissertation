...
\begin{listofabbrv}{ABNT}%coloque aqui a maior sigla para ajustar a distância
  ...
  \item[CAR-STM] Collision Avoidance and Resolution
  \item[CI] Contention Intensity
  \item[HTM] Memória Transacional em Hardware 
  \item[LTMS] Lups Transactional Memory Schedule
  \item[LUTS] Light-Weight User-Level Transaction Scheduler
  \item[NUMA] Non-Uniform Memory Access
  \item[RCE] Registro de Contexto em Execução
  \item[STAMP] Stanford Transactional Applications for Multi-Processing
  \item[STM] Memória Transacional em Software
  \item[STMap] Sharing-Aware Thread Mapping
  \item[TM] Memória Transacional
  \item[TP] Tempo Perdido
