...
A tabela~\ref{tab:compare_ltms} apresenta uma comparação entre as características dos escalonadores atuais a fim de entender o impacto que os escalonadores podem fornecer ao sistemas paralelos com uso de STM.

\begin{table}[]
  \footnotesize
  \centering
  \caption{Comparativo entre os escalonadores}
